...
* [`src/gitframe/`](src/gitframe/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/gitframe/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `gitframe` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/gitframe/config.cljs) defaults to `true` in
...
```clj
(ns gitframe.example
  (:require [gitframe.config :as config])
